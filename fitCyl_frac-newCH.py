...
bkg=np.average(IQ[-15:,])
print(bkg)

fracx=np.log(Q[1:15])
fracy=np.log(IQ[1:15])
...
cd= 3*pow(10,-20)/10 #charge density in ~5e/A

guessval0=np.array([nD,rad,Lapp,cd,eclust])
guesslow0=np.array([0.01*nD,7,30,pow(10,-22),1000])
guesshigh0=np.array([100*nD,11,Lapp*5,pow(10,1)*cd,pow(10,5)*eclust])
gscale0=[pow(10,21),0.1,0.1,pow(10,-22),100.]
